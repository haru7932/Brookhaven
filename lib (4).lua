...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Alerta",
			Text = "Tem certeza que deseja fechar o SharkZ Client? Pode causar erros se tiver com funções importantes ligadas!",
			Options = {
				{"Confirmar", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", SaveSize, 0.5, true})
	...
	function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddDropdown(Configs)
            ...
            local ActiveLabel = InsertTheme(Create("TextLabel", SelectedFrame, {
                ...
                TextScaled = true,
                TextColor3 = Theme["Color Text"],
                Text = "<font face='Gotham'><i>...</i></font>",
                RichText = true
            }), "Text")
            ...
            local AddNewOptions, GetOptions, AddOption, RemoveOption, Selected do
                ...
                local function UpdateLabel()
                    if MultiSelect then
                        ...
                        ActiveLabel.Text = "<font face='Gotham'><i>" .. (#list > 0 and table.concat(list, ", ") or "...") .. "</i></font>"
                    else
                        ActiveLabel.Text = "<font face='Gotham'><i>" .. tostring(Selected or "...") .. "</i></font>"
                    end
                end
                ...
                AddOption = function(index, Value)
                    ...
                    local OptioneName = InsertTheme(Create("TextLabel", Button, {
                        ...
                        Text = "<font face='Gotham'><i>" .. Name .. "</i></font>",
                        TextColor3 = Theme["Color Text"],
                        Font = Enum.Font.Gotham,
                        TextXAlignment = "Left",
                        BackgroundTransparency = 1,
